...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        DecodedJWT decoded;
        try {
            JWTVerifier verifier = JWT.require(Algorithm.HMAC512(SecurityService.key)).withIssuer("develhope-demo").build();
        ...
        Optional<User> userDetails = userRepo.findById(decoded.getClaim("id").asInt());
